...
<a href="https://lamarrinstitute.org" target="_blank"><img src="assets/logo.png" alt="Stanford-Alpaca" style="width: 50%; min-width: 300px; display: block; margin: auto;"></a>
</p>
...
This is a fork of the Stanford Alpaca project, which aims to build and share an instruction-following LLaMA model. This repo contains:
- The [52K data](#data-release) automatically translated to German for fine-tuning the model
...
[`german_data.json`](./german_data.json) contains the same 52K instruction-following data translated to German using deepl.
